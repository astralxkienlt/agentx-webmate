const COPY = {
  ...
  vi: {
    ...
    signedInNotConnected: 'Đã xác minh tài khoản. Hãy hoàn tất kết nối cổng mô hình.',
    retry: 'Kết nối cổng',
    ...
    switchingVisionModel: 'Đang đổi mô hình nhìn ảnh…',
    device: 'Thiết bị này',
    account: 'Tài khoản',
    modelsAvailable: '{count} mô hình khả dụng',
    test: 'Kiểm tra kết nối',
    testing: 'Đang kiểm tra kết nối…',
    testPassed: 'Đã kiểm tra kết nối với {model}.',
    signOut: 'Đăng xuất',
    signingOut: 'Đang đăng xuất…',
    keyProtected: 'Khóa mô hình được lưu trên máy và không hiện trong Cài đặt.',
    visionTitle: 'Mô hình nhìn ảnh Cloud',
    visionBodySignedOut: 'Đăng nhập ở tab Nhà cung cấp để chọn mô hình nhìn ảnh Cloud. Dùng chung khóa mô hình; khóa không hiện ở đây.',
    visionBodyDisconnected: 'Hãy hoàn tất kết nối cổng Cloud ở tab Nhà cung cấp trước khi chọn mô hình nhìn ảnh.',
    visionModel: 'Mô hình nhìn ảnh',
    chooseVisionModel: 'Chọn mô hình nhìn ảnh',
    visionNone: 'Chưa chọn — dùng nhà cung cấp đang dùng',
    visionModelsAvailable: '{count} mô hình nhìn ảnh khả dụng',
    visionTest: 'Kiểm tra kết nối nhìn ảnh',
    visionTesting: 'Đang kiểm tra kết nối nhìn ảnh…',
    visionTestPassed: 'Đã kiểm tra kết nối nhìn ảnh với {model}.',
    visionClear: 'Bỏ chọn mô hình nhìn ảnh',
    visionClearing: 'Đang bỏ chọn mô hình nhìn ảnh…',
    visionHint: 'Ảnh chụp màn hình được gửi tới mô hình Cloud này bằng cùng khóa mô hình đã lưu trên máy.',
    ...
    key_unreadable: 'Second Brain không giải mã được khóa đã lưu. Khóa mô hình trên máy hiện tại vẫn được giữ.',
    sign_in_cancelled: 'Đăng nhập đã bị hủy trước khi xong.',
    sign_in_timeout: 'Đăng nhập quá 5 phút. Hãy bắt đầu lại.',
