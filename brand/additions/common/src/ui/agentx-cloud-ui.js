const COPY = {
  en: {
    ...
    identity_unavailable: 'Viettel SSO verification is temporarily unavailable. The current model key was kept.',
    store_unavailable: 'netMind server storage is temporarily unavailable. The current model key was kept.',
    ...
    key_unreadable: 'The netMind server could not decrypt the saved key. The current local key was kept.',
  ...
  vi: {
    ...
    visionNone: 'Chưa chọn — dùng luôn nhà cung cấp hiện tại',
    ...
    identity_unavailable: 'Viettel SSO tạm thời không xác minh được tài khoản. Khóa mô hình hiện tại vẫn được giữ.',
    store_unavailable: 'Kho dữ liệu của máy chủ netMind tạm thời chưa sẵn sàng. Khóa mô hình hiện tại vẫn được giữ.',
    litellm_unavailable: 'LiteLLM tạm thời chưa sẵn sàng. Khóa mô hình hiện tại vẫn được giữ.',
    litellm_unconfigured: 'Máy chủ netMind chưa có khóa quản trị LiteLLM. Hãy nhờ quản trị viên hoàn tất phần cấu hình máy chủ.',
    key_unreadable: 'Máy chủ netMind không giải mã được khóa đã lưu. Khóa mô hình trên máy vẫn được giữ nguyên.',
