...
- Permission-mode copy now matches behaviour in all 23 locales. Auto's description lists running page scripts among what it still asks about (it always did), and Bypass's says it accepts every permission *and* runs the plan without asking you to approve it.
