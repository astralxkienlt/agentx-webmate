...
const PROVIDERS = [
  ...
  provider('minimax-cn-coding-plan', 'MiniMax Token Plan (China)', 'https://api.minimaxi.com/v1', 'MiniMax-M3', 1000000, { category: 'cloud', apiKeyUrl: 'https://platform.minimaxi.com/docs/token-plan/intro', suggestions: ['MiniMax-M3', 'MiniMax-M2.7'] }),
  provider('minimax-coding-plan', 'MiniMax Token Plan', 'https://api.minimax.io/v1', 'MiniMax-M3', 1000000, { category: 'cloud', apiKeyUrl: 'https://platform.minimax.io/docs/token-plan/intro', suggestions: ['MiniMax-M3', 'MiniMax-M2.7'] }),
  ...
  provider('modelscope', 'ModelScope', 'https://api-inference.modelscope.cn/v1', 'Qwen/Qwen3.8-27B', 262144, { apiKeyUrl: 'https://modelscope.cn/docs/model-service/API-Inference/intro' }),
  ...
  provider('siliconflow', 'SiliconFlow', 'https://api.siliconflow.com/v1', 'moonshotai/Kimi-K3', 1048576, { apiKeyUrl: 'https://cloud.siliconflow.com/account/ak', inputCostPerMillionUsd: 3, cacheReadCostPerMillionUsd: 0.3, outputCostPerMillionUsd: 15 }),
  ...
  provider('stepfun', 'StepFun', 'https://api.stepfun.com/v1', 'step-3.7-flash', 262144, { category: 'cloud', apiKeyUrl: 'https://platform.stepfun.com/docs/zh/overview/concept', inputCostPerMillionUsd: 2.05, cacheReadCostPerMillionUsd: 0.41, outputCostPerMillionUsd: 9.59, suggestions: ['step-3.7-flash', 'step-3.5-flash'] }),
