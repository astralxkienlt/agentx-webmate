...
export default {
  ...
  'st.skills.add_file': ".md dosyasından içe aktar",
  'st.skills.file_hint': ".md dosyalarını bu karta sürükleyip bırakabilirsiniz.",
  'st.skills.added_multi': "{count} beceri eklendi.",
  'st.skills.error.file_read': "{name} okunamadı.",
  'st.skills.error.file_type': "{name} desteklenen bir beceri dosyası değil (.md, .markdown, .txt).",
  'st.skills.edit': "Düzenle",
  'st.skills.editing': "Düzenleniyor: {name}",
  'st.skills.editing_hint': "Değişiklikleri kaydetmek bu paketli veya URL'den içe aktarılmış beceriyi özel metne dönüştürür; artık otomatik güncelleme almaz.",
  'st.skills.save_edit': "Değişiklikleri kaydet",
  'st.skills.cancel_edit': "Düzenlemeyi iptal et",
  'st.skills.updated': "Beceri güncellendi.",
  'st.skills.error.update_missing': "Bu beceri artık yok — başka bir pencerede silinmiş olabilir.",
  'st.skills.chars_count': "{count} / {max} karakter",
  'st.skills.chars_over': "{max} karakteri aşan metin kaydedilirken kesilir.",
  'st.skills.draft.title': "Şu şekilde kaydedilecek",
  'st.skills.draft.modes': "Modlar: {modes}",
  'st.skills.draft.intents': "Niyetler: {intents}",
  ...
  'sp.permmode.auto.desc': "WebBrain kendi başına gezinir, tıklar ve yazar. Form göndermeden, sayfada betik çalıştırmadan, indirmeden, dosya yüklemeden, API'ye yazmadan veya iş planlamadan önce yine sorar.",
  ...
  'sp.model.open': 'Model seç',
  'sp.model.heading': 'Model',
  'sp.model.changed': 'Model: {model}',
  'sp.model.switch_failed': 'Model değiştirilemedi: {error}',
  'sp.model.vision_inherit': 'Görseller ve ekran görüntüleri de bu model tarafından okunur.',
  'sp.model.vision_dedicated': 'Görseller ve ekran görüntüleri {model} tarafından okunur.',
  ...
  'sp.attach.mime_mismatch': '{name} reddedildi: dosya içeriği beyan edilen dosya türüyle eşleşmiyor.',
  'sp.attach.doc_legacy': '{name} eski biçimli bir Word dosyası (.doc). Dosyayı .docx olarak kaydedip yeniden ekleyin.',
  'sp.attach.drop_hint': 'Eklemek için dosyaları buraya bırakın',
  'sp.attach.hint.pdf': 'PDF · {pages} sayfa',
  'sp.attach.hint.pdf_scan': 'Taranmış PDF · {pages} sayfa — görüntü destekli model gerekir',
  'sp.attach.hint.invalid_docx': 'Okunamayan .docx dosyası',
  'sp.attach.outcome.sent_native': 'Modele gönderildi',
  'sp.attach.outcome.sent_text': 'Çıkarılan metin olarak gönderildi',
  'sp.attach.outcome.sent_pages': 'Sayfa görüntüleri olarak gönderildi',
  'sp.attach.outcome.reference': 'Ajanın gerektiğinde okuyabileceği bir referans olarak eklendi',
  'sp.attach.outcome.needs_vision': 'Gönderilmedi — seçilen model görüntüleri göremiyor',
  'sp.attach.outcome.needs_vision_scan': 'Gönderilmedi — bu taranmış PDF görüntü destekli model gerektirir',
  'sp.attach.outcome.policy': 'Gönderilmedi — bir güvenlik politikası tarafından engellendi',
  'sp.attach.outcome.expired': 'Gönderilmedi — depolanan dosyanın süresi doldu; yeniden ekleyin',
  'sp.attach.outcome.error': 'Gönderilmedi — dosya işlenemedi',
  ...
  "sp.plan.auto_approved_mode": "“{mode}” izin modu planı otomatik onayladı — çalışıyor…",
  ...
  'st.attach.heading': 'Ekler',
  'st.attach.desc': 'Eklenen dosyalar bu cihazda saklanır: yazma alanındaki çipler yeniden yüklemelerde kaybolmaz ve ajan gerektiğinde dosyanın daha fazlasını okuyabilir. Dosya içeriği yalnızca seçtiğiniz sağlayıcıya bir mesaj gönderildiğinde cihazdan çıkar.',
  'st.attach.retention.label': 'Eklenen dosyaları sakla',
  'st.attach.retention.desc': 'Eklenen dosyaların son kullanımdan sonra yerel depolamada ne kadar süre kalacağı.',
  'st.attach.retention.ttl24h': 'En fazla 24 saat',
  'st.attach.retention.session': 'Yalnızca geçerli tarayıcı oturumu',
  'st.attach.usage': '{count} kayıtlı dosya · {size}',
  'st.attach.clear.btn': 'Tüm eklenen dosyaları sil',
  'st.attach.clear.done': 'Tüm eklenen dosyalar silindi.',
  'st.attach.clear.failed': 'Eklenen dosyalar silinemedi.',
};
