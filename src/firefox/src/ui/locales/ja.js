...
export default {
  ...
  'sp.permmode.auto': '自動',
  'sp.permmode.auto.desc': "WebBrain が自分で移動・クリック・入力します。フォーム送信、ページスクリプトの実行、ダウンロード、アップロード、API への書き込み、予定登録の前には確認します。",
  ...
  'sp.model.open': 'モデルを選択',
  'sp.model.heading': 'モデル',
  'sp.model.changed': 'モデル: {model}',
  'sp.model.switch_failed': 'モデルを切り替えられませんでした: {error}',
  'sp.model.vision_inherit': '画像とスクリーンショットもこのモデルが読み取ります。',
  'sp.model.vision_dedicated': '画像とスクリーンショットは {model} が読み取ります。',
  ...
  'st.skills.add_file': ".md ファイルから取り込む",
  'st.skills.file_hint': ".md ファイルをこのカードにドラッグ＆ドロップすることもできます。",
  'st.skills.added_multi': "{count} 件のスキルを追加しました。",
  'st.skills.error.file_read': "{name} を読み込めませんでした。",
  'st.skills.error.file_type': "{name} は対応していないスキルファイルです（.md、.markdown、.txt）。",
  'st.skills.edit': "編集",
  'st.skills.editing': "編集中: {name}",
  'st.skills.editing_hint': "変更を保存すると、このパッケージ/URL 取り込みスキルはカスタムテキストに変換され、自動更新されなくなります。",
  'st.skills.save_edit': "変更を保存",
  'st.skills.cancel_edit': "編集をキャンセル",
  'st.skills.updated': "スキルを更新しました。",
  'st.skills.error.update_missing': "このスキルは存在しません。別のウィンドウで削除された可能性があります。",
  'st.skills.chars_count': "{count} / {max} 文字",
  'st.skills.chars_over': "{max} 文字を超える部分は保存時に切り捨てられます。",
  'st.skills.draft.title': "保存される内容",
  'st.skills.draft.modes': "モード: {modes}",
  'st.skills.draft.intents': "インテント: {intents}",
  ...
  'sp.attach.mime_mismatch': '{name} は拒否されました：ファイルの内容が宣言された種類と一致しません。',
  'sp.attach.doc_legacy': '{name} は旧形式の Word ファイル（.doc）です。.docx として保存し直してから再度添付してください。',
  'sp.attach.drop_hint': 'ここにファイルをドロップして添付',
  'sp.attach.hint.pdf': 'PDF · {pages} ページ',
  'sp.attach.hint.pdf_scan': 'スキャン PDF · {pages} ページ — ビジョン対応モデルが必要',
  'sp.attach.hint.invalid_docx': '読み取れない .docx ファイル',
  'sp.attach.outcome.sent_native': 'モデルに送信済み',
  'sp.attach.outcome.sent_text': '抽出テキストとして送信済み',
  'sp.attach.outcome.sent_pages': 'ページ画像として送信済み',
  'sp.attach.outcome.reference': '参照として添付済み — エージェントが必要時に読み取れます',
  'sp.attach.outcome.needs_vision': '未送信 — 選択中のモデルは画像を表示できません',
  'sp.attach.outcome.needs_vision_scan': '未送信 — このスキャン PDF にはビジョン対応モデルが必要です',
  'sp.attach.outcome.policy': '未送信 — 安全ポリシーによりブロックされました',
  'sp.attach.outcome.expired': '未送信 — 保存されたファイルの期限が切れました。再度添付してください',
  'sp.attach.outcome.error': '未送信 — ファイルを処理できませんでした',
  ...
  "sp.plan.auto_approved_mode": "権限モード「{mode}」によりプランを自動承認しました — 実行中…",
  ...
  'st.attach.heading': '添付ファイル',
  'st.attach.desc': '添付ファイルはこの端末に保存されるため、再読み込み後もチップが残り、エージェントは必要に応じてファイルの続きを読めます。ファイルの内容が端末の外に出るのは、選択したプロバイダーへメッセージを送信するときだけです。',
  'st.attach.retention.label': '添付ファイルの保持',
  'st.attach.retention.desc': '最後に使用してから添付ファイルをローカルストレージに保持する期間。',
  'st.attach.retention.ttl24h': '最長 24 時間',
  'st.attach.retention.session': '現在のブラウザーセッションのみ',
  'st.attach.usage': '{count} 件のファイルを保存中 · {size}',
  'st.attach.clear.btn': '添付ファイルをすべて削除',
  'st.attach.clear.done': '添付ファイルをすべて削除しました。',
  'st.attach.clear.failed': '添付ファイルを削除できませんでした。',
};
