...
export default {
  ...
  'sp.permmode.auto.desc': "WebBrain menjelajah, mengeklik, dan mengetik sendiri. WebBrain tetap bertanya sebelum mengirim formulir, menjalankan skrip halaman, mengunduh, mengunggah, menulis ke API, atau menjadwalkan pekerjaan.",
  ...
  'sp.model.open': 'Pilih model',
  'sp.model.heading': 'Model',
  'sp.model.changed': 'Model: {model}',
  'sp.model.switch_failed': 'Tidak dapat mengganti model: {error}',
  'sp.model.vision_inherit': 'Gambar dan tangkapan layar juga dibaca oleh model ini.',
  'sp.model.vision_dedicated': 'Gambar dan tangkapan layar dibaca oleh {model}.',
  ...
  'st.skills.add_file': "Impor dari file .md",
  'st.skills.file_hint': "Anda juga dapat menyeret dan melepas file .md ke kartu ini.",
  'st.skills.added_multi': "{count} keterampilan ditambahkan.",
  'st.skills.error.file_read': "Tidak dapat membaca {name}.",
  'st.skills.error.file_type': "{name} bukan file keterampilan yang didukung (.md, .markdown, .txt).",
  'st.skills.edit': "Edit",
  'st.skills.editing': "Mengedit: {name}",
  'st.skills.editing_hint': "Menyimpan perubahan mengubah keterampilan bawaan atau impor URL ini menjadi teks kustom; ia tidak lagi menerima pembaruan otomatis.",
  'st.skills.save_edit': "Simpan perubahan",
  'st.skills.cancel_edit': "Batalkan pengeditan",
  'st.skills.updated': "Keterampilan diperbarui.",
  'st.skills.error.update_missing': "Keterampilan ini sudah tidak ada — mungkin telah dihapus di jendela lain.",
  'st.skills.chars_count': "{count} / {max} karakter",
  'st.skills.chars_over': "Teks melebihi {max} karakter akan dipotong saat disimpan.",
  'st.skills.draft.title': "Akan disimpan sebagai",
  'st.skills.draft.modes': "Mode: {modes}",
  'st.skills.draft.intents': "Intent: {intents}",
  ...
  'sp.attach.mime_mismatch': '{name} ditolak: isi berkas tidak cocok dengan jenis berkas yang dinyatakan.',
  'sp.attach.doc_legacy': '{name} adalah berkas Word format lama (.doc). Simpan sebagai .docx lalu lampirkan lagi.',
  'sp.attach.drop_hint': 'Letakkan berkas di sini untuk melampirkan',
  'sp.attach.hint.pdf': 'PDF · {pages} halaman',
  'sp.attach.hint.pdf_scan': 'PDF hasil pindaian · {pages} halaman — perlu model dengan visi',
  'sp.attach.hint.invalid_docx': 'Berkas .docx tidak dapat dibaca',
  'sp.attach.outcome.sent_native': 'Terkirim ke model',
  'sp.attach.outcome.sent_text': 'Terkirim sebagai teks hasil ekstraksi',
  'sp.attach.outcome.sent_pages': 'Terkirim sebagai gambar halaman',
  'sp.attach.outcome.reference': 'Dilampirkan sebagai referensi yang bisa dibaca agen saat diperlukan',
  'sp.attach.outcome.needs_vision': 'Tidak terkirim — model yang dipilih tidak dapat melihat gambar',
  'sp.attach.outcome.needs_vision_scan': 'Tidak terkirim — PDF pindaian ini memerlukan model dengan visi',
  'sp.attach.outcome.policy': 'Tidak terkirim — diblokir oleh kebijakan keamanan',
  'sp.attach.outcome.expired': 'Tidak terkirim — berkas tersimpan sudah kedaluwarsa; lampirkan lagi',
  'sp.attach.outcome.error': 'Tidak terkirim — berkas tidak dapat diproses',
  ...
  "sp.plan.auto_approved_mode": "Rencana disetujui otomatis oleh mode izin “{mode}” — sedang berjalan…",
  ...
  'st.attach.heading': 'Lampiran',
  'st.attach.desc': 'Berkas yang dilampirkan disimpan di perangkat ini, sehingga chip lampiran tetap ada setelah dimuat ulang dan agen dapat membaca lebih banyak isi berkas saat diperlukan. Isi berkas hanya keluar dari perangkat saat pesan dikirim ke penyedia pilihan Anda.',
  'st.attach.retention.label': 'Simpan berkas terlampir',
  'st.attach.retention.desc': 'Berapa lama berkas terlampir disimpan di penyimpanan lokal setelah terakhir digunakan.',
  'st.attach.retention.ttl24h': 'Hingga 24 jam',
  'st.attach.retention.session': 'Hanya sesi browser saat ini',
  'st.attach.usage': '{count} berkas tersimpan · {size}',
  'st.attach.clear.btn': 'Hapus semua berkas terlampir',
  'st.attach.clear.done': 'Semua berkas terlampir telah dihapus.',
  'st.attach.clear.failed': 'Tidak dapat menghapus berkas terlampir.',
};
