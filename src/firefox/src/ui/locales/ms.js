...
export default {
  ...
  'sp.permmode.auto.desc': "WebBrain menavigasi, mengklik dan menaip sendiri. Ia masih bertanya sebelum menghantar borang, menjalankan skrip halaman, memuat turun, memuat naik, menulis ke API atau menjadualkan kerja.",
  ...
  'sp.model.switch_failed': 'Tidak dapat menukar model: {error}',
  'sp.model.vision_inherit': 'Imej dan tangkapan skrin turut dibaca oleh model ini.',
  'sp.model.vision_dedicated': 'Imej dan tangkapan skrin dibaca oleh {model}.',
  ...
  'st.skills.add_file': "Import daripada fail .md",
  'st.skills.file_hint': "Anda juga boleh seret dan lepas fail .md ke kad ini.",
  'st.skills.added_multi': "{count} kemahiran ditambah.",
  'st.skills.error.file_read': "Tidak dapat membaca {name}.",
  'st.skills.error.file_type': "{name} bukan fail kemahiran yang disokong (.md, .markdown, .txt).",
  'st.skills.edit': "Edit",
  'st.skills.editing': "Mengedit: {name}",
  'st.skills.editing_hint': "Menyimpan perubahan menukar kemahiran berpakej atau import URL ini kepada teks tersuai; ia tidak lagi menerima kemas kini automatik.",
  'st.skills.save_edit': "Simpan perubahan",
  'st.skills.cancel_edit': "Batal pengeditan",
  'st.skills.updated': "Kemahiran dikemas kini.",
  'st.skills.error.update_missing': "Kemahiran ini tiada lagi — mungkin telah dibuang di tetingkap lain.",
  'st.skills.chars_count': "{count} / {max} aksara",
  'st.skills.chars_over': "Teks melebihi {max} aksara akan dipotong semasa disimpan.",
  'st.skills.draft.title': "Akan disimpan sebagai",
  'st.skills.draft.modes': "Mod: {modes}",
  ...
  'sp.attach.mime_mismatch': '{name} ditolak: kandungan fail tidak sepadan dengan jenis fail yang diisytiharkan.',
  'sp.attach.doc_legacy': '{name} ialah fail Word format lama (.doc). Simpan sebagai .docx dan lampirkan semula.',
  'sp.attach.drop_hint': 'Lepaskan fail di sini untuk melampirkan',
  'sp.attach.hint.pdf': 'PDF · {pages} halaman',
  'sp.attach.hint.pdf_scan': 'PDF imbasan · {pages} halaman — memerlukan model dengan penglihatan',
  'sp.attach.hint.invalid_docx': 'Fail .docx tidak boleh dibaca',
  'sp.attach.outcome.sent_native': 'Dihantar kepada model',
  'sp.attach.outcome.sent_text': 'Dihantar sebagai teks yang diekstrak',
  'sp.attach.outcome.sent_pages': 'Dihantar sebagai imej halaman',
  'sp.attach.outcome.reference': 'Dilampirkan sebagai rujukan yang boleh dibaca ejen apabila perlu',
  'sp.attach.outcome.needs_vision': 'Tidak dihantar — model yang dipilih tidak dapat melihat imej',
  'sp.attach.outcome.needs_vision_scan': 'Tidak dihantar — PDF imbasan ini memerlukan model dengan penglihatan',
  'sp.attach.outcome.policy': 'Tidak dihantar — disekat oleh dasar keselamatan',
  'sp.attach.outcome.expired': 'Tidak dihantar — fail tersimpan telah luput; lampirkan semula',
  'sp.attach.outcome.error': 'Tidak dihantar — fail tidak dapat diproses',
  ...
  "sp.plan.auto_approved_mode": "Rancangan diluluskan automatik oleh mod kebenaran “{mode}” — sedang berjalan…",
  ...
  'st.attach.desc': 'Fail yang dilampirkan disimpan pada peranti ini, jadi cip lampiran kekal selepas muat semula dan ejen boleh membaca lebih banyak kandungan fail apabila perlu. Kandungan fail hanya meninggalkan peranti apabila mesej dihantar kepada penyedia pilihan anda.',
  'st.attach.retention.label': 'Simpan fail yang dilampirkan',
  'st.attach.retention.desc': 'Tempoh fail yang dilampirkan kekal dalam storan tempatan selepas penggunaan terakhir.',
  'st.attach.retention.ttl24h': 'Sehingga 24 jam',
  'st.attach.retention.session': 'Sesi pelayar semasa sahaja',
  'st.attach.usage': '{count} fail disimpan · {size}',
  'st.attach.clear.btn': 'Padam semua fail yang dilampirkan',
  'st.attach.clear.done': 'Semua fail yang dilampirkan telah dipadamkan.',
  'st.attach.clear.failed': 'Tidak dapat memadamkan fail yang dilampirkan.',
};
