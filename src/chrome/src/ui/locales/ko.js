...
export default {
  ...
  'sp.permmode.auto': '자동',
  'sp.permmode.auto.desc': "WebBrain이 스스로 이동하고 클릭하고 입력합니다. 양식 제출, 페이지 스크립트 실행, 다운로드, 업로드, API 쓰기, 작업 예약 전에는 여전히 확인합니다.",
  ...
  'sp.model.open': '모델 선택',
  'sp.model.heading': '모델',
  'sp.model.changed': '모델: {model}',
  'sp.model.switch_failed': '모델을 전환하지 못했습니다: {error}',
  'sp.model.vision_inherit': '이미지와 스크린샷도 이 모델이 읽습니다.',
  'sp.model.vision_dedicated': '이미지와 스크린샷은 {model} 모델이 읽습니다.',
  ...
  'st.skills.add_file': ".md 파일에서 가져오기",
  'st.skills.file_hint': ".md 파일을 이 카드로 끌어다 놓을 수도 있습니다.",
  'st.skills.added_multi': "스킬 {count}개를 추가했습니다.",
  'st.skills.error.file_read': "{name} 파일을 읽을 수 없습니다.",
  'st.skills.error.file_type': "{name}은(는) 지원되지 않는 스킬 파일입니다(.md, .markdown, .txt).",
  'st.skills.edit': "편집",
  'st.skills.editing': "편집 중: {name}",
  'st.skills.editing_hint': "변경 사항을 저장하면 이 패키지/URL 가져오기 스킬이 사용자 지정 텍스트로 전환되어 더 이상 자동 업데이트되지 않습니다.",
  'st.skills.save_edit': "변경 사항 저장",
  'st.skills.cancel_edit': "편집 취소",
  'st.skills.updated': "스킬이 업데이트되었습니다.",
  'st.skills.error.update_missing': "이 스킬은 더 이상 존재하지 않습니다. 다른 창에서 삭제되었을 수 있습니다.",
  'st.skills.chars_count': "{count} / {max}자",
  'st.skills.chars_over': "{max}자를 초과한 내용은 저장 시 잘립니다.",
  'st.skills.draft.title': "저장될 내용",
  'st.skills.draft.modes': "모드: {modes}",
  'st.skills.draft.intents': "인텐트: {intents}",
  ...
  'sp.attach.mime_mismatch': '{name}이(가) 거부되었습니다. 파일 내용이 선언된 형식과 일치하지 않습니다.',
  'sp.attach.doc_legacy': '{name}은(는) 구형 Word 파일(.doc)입니다. .docx로 저장한 뒤 다시 첨부하세요.',
  'sp.attach.drop_hint': '파일을 여기에 끌어다 첨부',
  'sp.attach.hint.pdf': 'PDF · {pages}쪽',
  'sp.attach.hint.pdf_scan': '스캔 PDF · {pages}쪽 — 비전 모델 필요',
  'sp.attach.hint.invalid_docx': '읽을 수 없는 .docx 파일',
  'sp.attach.outcome.sent_native': '모델로 전송됨',
  'sp.attach.outcome.sent_text': '추출된 텍스트로 전송됨',
  'sp.attach.outcome.sent_pages': '페이지 이미지로 전송됨',
  'sp.attach.outcome.reference': '참조로 첨부됨 — 에이전트가 필요할 때 읽을 수 있음',
  'sp.attach.outcome.needs_vision': '전송 안 됨 — 선택한 모델이 이미지를 볼 수 없습니다',
  'sp.attach.outcome.needs_vision_scan': '전송 안 됨 — 이 스캔 PDF는 비전 모델이 필요합니다',
  'sp.attach.outcome.policy': '전송 안 됨 — 안전 정책에 의해 차단됨',
  'sp.attach.outcome.expired': '전송 안 됨 — 저장된 파일이 만료되었습니다. 다시 첨부하세요',
  'sp.attach.outcome.error': '전송 안 됨 — 파일을 처리할 수 없습니다',
  "sp.queue.label": "대기 중",
  ...
  "sp.plan.auto_approved_mode": "권한 모드 “{mode}”에 따라 계획을 자동 승인했습니다 — 실행 중…",
  ...
  'st.attach.heading': '첨부 파일',
  'st.attach.desc': '첨부한 파일은 이 기기에 저장되어 다시 로드해도 입력창의 칩이 유지되고, 에이전트가 필요할 때 파일 내용을 더 읽을 수 있습니다. 파일 내용은 선택한 제공업체로 메시지를 보낼 때만 기기를 떠납니다.',
  'st.attach.retention.label': '첨부 파일 보관',
  'st.attach.retention.desc': '마지막 사용 후 첨부 파일을 로컬 저장소에 보관하는 기간.',
  'st.attach.retention.ttl24h': '최대 24시간',
  'st.attach.retention.session': '현재 브라우저 세션 동안만',
  'st.attach.usage': '저장된 파일 {count}개 · {size}',
  'st.attach.clear.btn': '첨부 파일 모두 삭제',
  'st.attach.clear.done': '첨부 파일을 모두 삭제했습니다.',
  'st.attach.clear.failed': '첨부 파일을 삭제하지 못했습니다.',
};
