...
export default {
  ...
  'sp.permmode.auto.desc': "Nag-navigate, nag-click at nag-type ang WebBrain nang mag-isa. Nagtatanong pa rin ito bago magsumite ng form, magpatakbo ng script sa pahina, mag-download, mag-upload, magsulat sa API, o mag-schedule ng trabaho.",
  ...
  'sp.model.open': 'Pumili ng model',
  'sp.model.heading': 'Model',
  'sp.model.changed': 'Model: {model}',
  'sp.model.switch_failed': 'Hindi mapalitan ang model: {error}',
  'sp.model.vision_inherit': 'Ang mga larawan at screenshot ay binabasa rin ng model na ito.',
  'sp.model.vision_dedicated': 'Ang mga larawan at screenshot ay binabasa ng {model}.',
  ...
  'st.skills.add_file': "Mag-import mula sa .md file",
  'st.skills.file_hint': "Maaari mo ring i-drag at i-drop ang mga .md file sa card na ito.",
  'st.skills.added_multi': "Naidagdag ang {count} na skill.",
  'st.skills.error.file_read': "Hindi mabasa ang {name}.",
  'st.skills.error.file_type': "Ang {name} ay hindi suportadong skill file (.md, .markdown, .txt).",
  'st.skills.edit': "I-edit",
  'st.skills.editing': "Ine-edit: {name}",
  'st.skills.editing_hint': "Ang pag-save ng mga pagbabago ay gagawing custom na teksto ang packaged o URL-imported na skill na ito; hindi na ito makakatanggap ng awtomatikong update.",
  'st.skills.save_edit': "I-save ang mga pagbabago",
  'st.skills.cancel_edit': "Kanselahin ang pag-edit",
  'st.skills.updated': "Na-update ang skill.",
  'st.skills.error.update_missing': "Wala na ang skill na ito — maaaring natanggal ito sa ibang window.",
  'st.skills.chars_count': "{count} / {max} character",
  'st.skills.chars_over': "Ang tekstong lampas sa {max} character ay puputulin kapag na-save.",
  'st.skills.draft.title': "Ise-save bilang",
  'st.skills.draft.modes': "Mga mode: {modes}",
  'st.skills.draft.intents': "Mga intent: {intents}",
  ...
  'st.display.cloud_bridge.desc': 'Ikonekta ang isang lokal na controller sa Chromium profile na ito. Gamitin ang port 17374 para sa mga MCP client, 17375 para sa LM Studio plugin, o 17373 para sa isang cloud run service. Isang bridge lang ang maaaring aktibo; nalalapat pa rin ang karaniwang mga prompt ng pahintulot.',
  ...
  'sp.attach.mime_mismatch': 'Tinanggihan ang {name}: hindi tugma ang nilalaman ng file sa idineklarang uri nito.',
  'sp.attach.doc_legacy': 'Ang {name} ay lumang format na Word file (.doc). I-save ito bilang .docx at muling ilakip.',
  'sp.attach.drop_hint': 'Ihulog ang mga file dito para ilakip',
  'sp.attach.hint.pdf': 'PDF · {pages} na pahina',
  'sp.attach.hint.pdf_scan': 'Naka-scan na PDF · {pages} na pahina — nangangailangan ng vision model',
  'sp.attach.hint.invalid_docx': 'Hindi mabasang .docx file',
  'sp.attach.outcome.sent_native': 'Naipadala sa model',
  'sp.attach.outcome.sent_text': 'Naipadala bilang na-extract na teksto',
  'sp.attach.outcome.sent_pages': 'Naipadala bilang mga larawan ng pahina',
  'sp.attach.outcome.reference': 'Inilakip bilang sanggunian na mababasa ng agent kapag kailangan',
  'sp.attach.outcome.needs_vision': 'Hindi naipadala — hindi nakakakita ng larawan ang napiling model',
  'sp.attach.outcome.needs_vision_scan': 'Hindi naipadala — kailangan ng vision model ang naka-scan na PDF na ito',
  'sp.attach.outcome.policy': 'Hindi naipadala — hinarang ng patakarang pangkaligtasan',
  'sp.attach.outcome.expired': 'Hindi naipadala — nag-expire na ang nakaimbak na file; muling ilakip',
  'sp.attach.outcome.error': 'Hindi naipadala — hindi maproseso ang file',
  ...
  "sp.plan.auto_approved_mode": "Awtomatikong inaprubahan ang plano ng permission mode na “{mode}” — tumatakbo…",
  ...
  'st.attach.heading': 'Mga attachment',
  'st.attach.desc': 'Nakaimbak sa device na ito ang mga inilakip na file, kaya nananatili ang mga chip pagkatapos ng reload at nababasa ng agent ang karagdagang nilalaman ng file kapag kailangan. Aalis lang sa device ang nilalaman ng file kapag ipinadala ang mensahe sa provider na pinili mo.',
  'st.attach.retention.label': 'Itago ang mga inilakip na file',
  'st.attach.retention.desc': 'Kung gaano katagal mananatili sa lokal na imbakan ang mga inilakip na file pagkatapos ng huling paggamit.',
  'st.attach.retention.ttl24h': 'Hanggang 24 na oras',
  'st.attach.retention.session': 'Kasalukuyang session lang ng browser',
  'st.attach.usage': '{count} nakaimbak na file · {size}',
  'st.attach.clear.btn': 'Burahin ang lahat ng inilakip na file',
  'st.attach.clear.done': 'Nabura ang lahat ng inilakip na file.',
  'st.attach.clear.failed': 'Hindi mabura ang mga inilakip na file.',
};
