...
export default {
  ...
  'sp.tab_chat_restore_failed': "تعذّر تحميل المحادثة المحفوظة لأن خلفية الإضافة لا تستجيب. حفاظًا عليها، لن يُحفَظ أي شيء لعلامة التبويب هذه حتى ينجح التحميل.",
  'sp.tab_chat_restore_reload': "إعادة تحميل اللوحة",
  ...
  'sp.permmode.auto.desc': "ينتقل WebBrain وينقر ويكتب من تلقاء نفسه، ولا يزال يسأل قبل إرسال نموذج أو تشغيل سكربتات في الصفحة أو التنزيل أو الرفع أو الكتابة عبر واجهة برمجية أو جدولة عمل.",
  ...
  'sp.model.open': 'اختيار النموذج',
  'sp.model.heading': 'النموذج',
  'sp.model.changed': 'النموذج: {model}',
  'sp.model.switch_failed': 'تعذّر تبديل النموذج: {error}',
  'sp.model.vision_inherit': 'الصور ولقطات الشاشة يقرؤها هذا النموذج أيضًا.',
  'sp.model.vision_dedicated': 'الصور ولقطات الشاشة يقرؤها {model}.',
  ...
  'st.skills.add_file': "استيراد من ملف ‎.md",
  'st.skills.file_hint': "يمكنك أيضًا سحب ملفات ‎.md وإفلاتها على هذه البطاقة.",
  'st.skills.added_multi': "تمت إضافة {count} من المهارات.",
  'st.skills.error.file_read': "تعذّرت قراءة {name}.",
  'st.skills.error.file_type': "{name} ليس ملف مهارة مدعومًا (‎.md، ‎.markdown، ‎.txt).",
  'st.skills.edit': "تعديل",
  'st.skills.editing': "جارٍ التعديل: {name}",
  'st.skills.editing_hint': "حفظ التغييرات يحوّل هذه المهارة المضمّنة أو المستوردة من URL إلى نص مخصص؛ ولن تتلقى تحديثات تلقائية بعد ذلك.",
  'st.skills.save_edit': "حفظ التغييرات",
  'st.skills.cancel_edit': "إلغاء التعديل",
  'st.skills.updated': "تم تحديث المهارة.",
  'st.skills.error.update_missing': "هذه المهارة لم تعد موجودة — ربما حُذفت في نافذة أخرى.",
  'st.skills.chars_count': "{count} / {max} حرفًا",
  'st.skills.chars_over': "سيُقتطع النص الذي يتجاوز {max} حرفًا عند الحفظ.",
  'st.skills.draft.title': "سيتم الحفظ باسم",
  'st.skills.draft.modes': "الأوضاع: {modes}",
  'st.skills.draft.intents': "النوايا: {intents}",
  ...
  'sp.attach.mime_mismatch': 'تم رفض {name}: محتوى الملف لا يطابق نوعه المعلن.',
  'sp.attach.doc_legacy': '{name} ملف Word بتنسيق قديم (.doc). احفظه بصيغة .docx ثم أرفقه من جديد.',
  'sp.attach.drop_hint': 'أفلت الملفات هنا لإرفاقها',
  'sp.attach.hint.pdf': 'PDF · {pages} صفحة',
  'sp.attach.hint.pdf_scan': 'PDF ممسوح ضوئيًا · {pages} صفحة — يتطلب نموذجًا يدعم الرؤية',
  'sp.attach.hint.invalid_docx': 'ملف .docx غير قابل للقراءة',
  'sp.attach.outcome.sent_native': 'أُرسل إلى النموذج',
  'sp.attach.outcome.sent_text': 'أُرسل كنص مستخرج',
  'sp.attach.outcome.sent_pages': 'أُرسل كصور لصفحات المستند',
  'sp.attach.outcome.reference': 'أُرفق كمرجع يمكن للوكيل قراءته عند الطلب',
  'sp.attach.outcome.needs_vision': 'لم يُرسل — النموذج المحدد لا يستطيع رؤية الصور',
  'sp.attach.outcome.needs_vision_scan': 'لم يُرسل — هذا الـ PDF الممسوح ضوئيًا يتطلب نموذجًا يدعم الرؤية',
  'sp.attach.outcome.policy': 'لم يُرسل — حُظر بموجب سياسة أمان',
  'sp.attach.outcome.expired': 'لم يُرسل — انتهت صلاحية الملف المخزَّن؛ أرفقه من جديد',
  'sp.attach.outcome.error': 'لم يُرسل — تعذّرت معالجة الملف',
  ...
  "sp.plan.auto_approved_mode": "تمت الموافقة على الخطة تلقائيًا حسب وضع الأذونات «{mode}» — جارٍ التشغيل…",
  ...
  'st.attach.heading': 'المرفقات',
  'st.attach.desc': 'تُحفظ الملفات المرفقة على هذا الجهاز، لذا تبقى شرائح المرفقات بعد إعادة التحميل ويستطيع الوكيل قراءة المزيد من الملف عند الطلب. لا يغادر محتوى الملف الجهاز إلا عند إرسال رسالة إلى المزوّد الذي اخترته.',
  'st.attach.retention.label': 'الاحتفاظ بالملفات المرفقة',
  'st.attach.retention.desc': 'مدة بقاء الملفات المرفقة في التخزين المحلي بعد آخر استخدام.',
  'st.attach.retention.ttl24h': 'حتى 24 ساعة',
  'st.attach.retention.session': 'جلسة المتصفح الحالية فقط',
  'st.attach.usage': '{count} ملفًا مخزّنًا · {size}',
  'st.attach.clear.btn': 'حذف جميع الملفات المرفقة',
  'st.attach.clear.done': 'حُذفت جميع الملفات المرفقة.',
  'st.attach.clear.failed': 'تعذّر حذف الملفات المرفقة.',
};
