...
export default {
  ...
  'sp.permmode.auto.desc': 'WebBrain navigates, clicks and types on its own. It still asks before submitting a form, downloading, uploading, writing to an API, or scheduling work.',
  ...
  'sp.permmode.bypass.desc': 'Accepts all permissions, on every site.',
