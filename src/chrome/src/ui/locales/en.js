...
export default {
  ...
  'sp.attach.mime_mismatch': '{name} was rejected: its content does not match its declared file type.',
  'sp.attach.doc_legacy': '{name} is an old-format Word file (.doc). Save it as .docx and attach it again.',
  'sp.attach.drop_hint': 'Drop files to attach',
  'sp.attach.hint.pdf': 'PDF · {pages} pages',
  'sp.attach.hint.pdf_scan': 'Scanned PDF · {pages} pages — needs a vision model',
  'sp.attach.hint.invalid_docx': 'Not a readable .docx file',
  'sp.attach.outcome.sent_native': 'Sent to the model',
  'sp.attach.outcome.sent_text': 'Sent as extracted text',
  'sp.attach.outcome.sent_pages': 'Sent as rendered page images',
  'sp.attach.outcome.reference': 'Attached as a reference the agent can read on demand',
  'sp.attach.outcome.needs_vision': 'Not sent — the selected model cannot view images',
  'sp.attach.outcome.needs_vision_scan': 'Not sent — this scanned PDF needs a vision model',
  'sp.attach.outcome.policy': 'Not sent — blocked by a safety policy',
  'sp.attach.outcome.expired': 'Not sent — the stored file expired; attach it again',
  'sp.attach.outcome.error': 'Not sent — the file could not be processed',
  ...
  'sp.plan.auto_approved_mode': "Plan auto-approved by permission mode “{mode}” — running…",
  ...
  'sp.perm.skip_hint': 'Want fewer interruptions? “Always allow” remembers this site, and the permission mode above the message box pre-approves whole classes of actions. The command below turns WebBrain permission prompts off on every site.',
  ...
  'sp.permmode.open': 'Permission mode',
  'sp.permmode.heading': 'Permissions',
  'sp.permmode.changed': 'Permission mode: {mode}',
  'sp.permmode.manual': 'Ask every time',
  'sp.permmode.manual.desc': 'WebBrain asks the first time it clicks, types, navigates, downloads, uploads, or schedules work on a site.',
  'sp.permmode.auto': 'Auto',
  'sp.permmode.auto.desc': "WebBrain navigates, clicks and types on its own. It still asks before submitting a form, running page scripts, downloading, uploading, writing to an API, or scheduling work.",
  ...
  'sp.model.open': 'Choose model',
  'sp.model.heading': 'Model',
  'sp.model.changed': 'Model: {model}',
  'sp.model.switch_failed': "Couldn't switch model: {error}",
  'sp.model.vision_inherit': 'Images and screenshots are read by this model too.',
  'sp.model.vision_dedicated': 'Images and screenshots are read by {model}.',
  ...
  'st.perms.mode.label': 'Permission mode',
  'st.perms.mode.desc': 'How much WebBrain may do without asking. Each step up pre-approves one more class of action; the sites you allowed one at a time are listed below.',
  'st.perms.mode.wide_warning': '⚠️ Form submits are auto-accepted. WebBrain will click, type, submit forms, and run page scripts on any site WITHOUT asking — including on pages whose content may be attacker-controlled. It still asks before downloads, uploads, API writes, and scheduled work.',
  ...
  'st.skills.add_file': "Import .md file",
  'st.skills.file_hint': "You can also drag and drop .md files onto this card.",
  'st.skills.added_multi': "Added {count} skills.",
  'st.skills.error.file_read': "Could not read {name}.",
  'st.skills.error.file_type': "{name} is not a supported skill file (.md, .markdown, .txt).",
  'st.skills.edit': "Edit",
  'st.skills.editing': "Editing: {name}",
  'st.skills.editing_hint': "Saving changes converts this packaged or URL-imported skill into custom text; it will stop receiving automatic updates.",
  'st.skills.save_edit': "Save changes",
  'st.skills.cancel_edit': "Cancel editing",
  'st.skills.updated': "Skill updated.",
  'st.skills.error.update_missing': "This skill no longer exists — it may have been removed in another window.",
  'st.skills.chars_count': "{count} / {max} characters",
  'st.skills.chars_over': "Text beyond {max} characters will be cut off when saved.",
  'st.skills.draft.title': "Will be saved as",
  'st.skills.draft.modes': "Modes: {modes}",
  'st.skills.draft.intents': "Intents: {intents}",
  ...
  'st.attach.heading': 'Attachments',
  'st.attach.desc': 'Attached files are kept on this device so composer chips survive reloads and the agent can read more of a file on demand. File content leaves the device only when a message is sent to the provider you selected.',
  'st.attach.retention.label': 'Keep attached files',
  'st.attach.retention.desc': 'How long attached files stay in local storage after their last use.',
  'st.attach.retention.ttl24h': 'Up to 24 hours',
  'st.attach.retention.session': 'Current browser session only',
  'st.attach.usage': '{count} stored files · {size}',
  'st.attach.clear.btn': 'Delete all attached files',
  'st.attach.clear.done': 'All attached files were deleted.',
  'st.attach.clear.failed': 'Could not delete the attached files.',
