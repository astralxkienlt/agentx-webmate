...
export default {
  ...
  'st.vision.desc': 'Choose a separate model to read screenshots while the active provider handles planning and tool calls. Leave it unset to use the active provider for vision. OpenAI-compatible endpoints only.',
  'st.vision.save': 'Save',
