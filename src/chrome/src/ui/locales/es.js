...
export default {
  ...
  'st.perms.mode.label': 'Modo de permisos',
  'st.perms.mode.desc': 'Cuánto puede hacer WebBrain sin preguntar. Cada nivel aprueba de antemano una clase más de acciones; los sitios que permitiste uno a uno aparecen abajo.',
  'st.perms.mode.wide_warning': '⚠️ Los formularios se envían automáticamente. WebBrain hará clic, escribirá, enviará formularios y ejecutará scripts de la página en cualquier sitio SIN preguntar, incluso en páginas cuyo contenido puede estar controlado por un atacante. Sigue preguntando antes de descargas, subidas, escrituras en API y trabajo programado.',
  ...
  'sp.permmode.open': 'Modo de permisos',
  'sp.permmode.heading': 'Permisos',
  'sp.permmode.changed': 'Modo de permisos: {mode}',
  'sp.permmode.manual': 'Preguntar siempre',
  'sp.permmode.manual.desc': 'WebBrain pregunta la primera vez que hace clic, escribe, navega, descarga, sube un archivo o programa trabajo en un sitio.',
  'sp.permmode.auto': 'Automático',
  'sp.permmode.auto.desc': "WebBrain navega, hace clic y escribe por su cuenta. Sigue preguntando antes de enviar un formulario, ejecutar scripts en la página, descargar, subir un archivo, escribir en una API o programar trabajo.",
  ...
  'sp.model.open': 'Elegir modelo',
  'sp.model.heading': 'Modelo',
  'sp.model.changed': 'Modelo: {model}',
  'sp.model.switch_failed': 'No se pudo cambiar el modelo: {error}',
  'sp.model.vision_inherit': 'Las imágenes y capturas de pantalla también las lee este modelo.',
  'sp.model.vision_dedicated': 'Las imágenes y capturas de pantalla las lee {model}.',
  ...
  'st.skills.add_file': "Importar archivo .md",
  'st.skills.file_hint': "También puedes arrastrar y soltar archivos .md sobre esta tarjeta.",
  'st.skills.added_multi': "Se añadieron {count} habilidades.",
  'st.skills.error.file_read': "No se pudo leer {name}.",
  'st.skills.error.file_type': "{name} no es un archivo de habilidad compatible (.md, .markdown, .txt).",
  'st.skills.edit': "Editar",
  'st.skills.editing': "Editando: {name}",
  'st.skills.editing_hint': "Guardar los cambios convierte esta habilidad empaquetada o importada por URL en texto personalizado; dejará de recibir actualizaciones automáticas.",
  'st.skills.save_edit': "Guardar cambios",
  'st.skills.cancel_edit': "Cancelar edición",
  'st.skills.updated': "Habilidad actualizada.",
  'st.skills.error.update_missing': "Esta habilidad ya no existe; puede haberse eliminado en otra ventana.",
  'st.skills.chars_count': "{count} / {max} caracteres",
  'st.skills.chars_over': "El texto que supere {max} caracteres se recortará al guardar.",
  'st.skills.draft.title': "Se guardará como",
  'st.skills.draft.modes': "Modos: {modes}",
  'st.skills.draft.intents': "Intenciones: {intents}",
  ...
  'st.display.cloud_bridge.desc': 'Conecta un controlador local a este perfil de Chromium. Usa el puerto 17374 para clientes MCP, 17375 para el complemento de LM Studio o 17373 para un servicio de ejecución en la nube. Solo puede haber un puente activo; los avisos de permisos siguen aplicándose.',
  ...
  'sp.attach.mime_mismatch': '{name} fue rechazado: su contenido no coincide con el tipo de archivo declarado.',
  'sp.attach.doc_legacy': '{name} es un archivo de Word en formato antiguo (.doc). Guárdalo como .docx y adjúntalo de nuevo.',
  'sp.attach.drop_hint': 'Suelta archivos aquí para adjuntarlos',
  'sp.attach.hint.pdf': 'PDF · {pages} páginas',
  'sp.attach.hint.pdf_scan': 'PDF escaneado · {pages} páginas — requiere un modelo con visión',
  'sp.attach.hint.invalid_docx': 'Archivo .docx ilegible',
  'sp.attach.outcome.sent_native': 'Enviado al modelo',
  'sp.attach.outcome.sent_text': 'Enviado como texto extraído',
  'sp.attach.outcome.sent_pages': 'Enviado como imágenes de páginas',
  'sp.attach.outcome.reference': 'Adjuntado como referencia que el agente puede leer bajo demanda',
  'sp.attach.outcome.needs_vision': 'No enviado: el modelo seleccionado no puede ver imágenes',
  'sp.attach.outcome.needs_vision_scan': 'No enviado: este PDF escaneado requiere un modelo con visión',
  'sp.attach.outcome.policy': 'No enviado: bloqueado por una política de seguridad',
  'sp.attach.outcome.expired': 'No enviado: el archivo almacenado caducó; adjúntalo de nuevo',
  'sp.attach.outcome.error': 'No enviado: el archivo no se pudo procesar',
  ...
  "sp.plan.auto_approved_mode": "Plan aprobado automáticamente por el modo de permisos «{mode}» — en ejecución…",
  ...
  'sp.perm.skip_hint': '¿Quieres menos interrupciones? «Permitir siempre» recuerda este sitio, y el modo de permisos que está sobre el cuadro de mensaje aprueba de antemano clases enteras de acciones. El comando de abajo desactiva las solicitudes de permiso de WebBrain en todos los sitios.',
  ...
  'st.attach.heading': 'Archivos adjuntos',
  'st.attach.desc': 'Los archivos adjuntos se guardan en este dispositivo: los chips del compositor sobreviven a las recargas y el agente puede leer más contenido del archivo bajo demanda. El contenido solo sale del dispositivo cuando se envía un mensaje al proveedor elegido.',
  'st.attach.retention.label': 'Conservar archivos adjuntos',
  'st.attach.retention.desc': 'Cuánto tiempo permanecen los archivos adjuntos en el almacenamiento local tras su último uso.',
  'st.attach.retention.ttl24h': 'Hasta 24 horas',
  'st.attach.retention.session': 'Solo la sesión actual del navegador',
  'st.attach.usage': '{count} archivos guardados · {size}',
  'st.attach.clear.btn': 'Eliminar todos los archivos adjuntos',
  'st.attach.clear.done': 'Se eliminaron todos los archivos adjuntos.',
  'st.attach.clear.failed': 'No se pudieron eliminar los archivos adjuntos.',
};
