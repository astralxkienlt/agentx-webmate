...
export default {
  ...
  'sp.permmode.auto.desc': "WebBrain navigue, clique et saisit du texte seul. Il demande encore avant d'envoyer un formulaire, d'exécuter des scripts sur la page, de télécharger, d'envoyer un fichier, d'écrire via une API ou de planifier un travail.",
  ...
  'sp.model.open': 'Choisir le modèle',
  'sp.model.heading': 'Modèle',
  'sp.model.changed': 'Modèle : {model}',
  'sp.model.switch_failed': 'Impossible de changer de modèle : {error}',
  'sp.model.vision_inherit': 'Les images et captures d’écran sont aussi lues par ce modèle.',
  'sp.model.vision_dedicated': 'Les images et captures d’écran sont lues par {model}.',
  ...
  'st.skills.add_file': "Importer un fichier .md",
  'st.skills.file_hint': "Vous pouvez aussi glisser-déposer des fichiers .md sur cette carte.",
  'st.skills.added_multi': "{count} compétences ajoutées.",
  'st.skills.error.file_read': "Impossible de lire {name}.",
  'st.skills.error.file_type': "{name} n'est pas un fichier de compétence pris en charge (.md, .markdown, .txt).",
  'st.skills.edit': "Modifier",
  'st.skills.editing': "Modification : {name}",
  'st.skills.editing_hint': "Enregistrer les modifications convertit cette compétence empaquetée ou importée par URL en texte personnalisé ; elle ne recevra plus de mises à jour automatiques.",
  'st.skills.save_edit': "Enregistrer les modifications",
  'st.skills.cancel_edit': "Annuler la modification",
  'st.skills.updated': "Compétence mise à jour.",
  'st.skills.error.update_missing': "Cette compétence n'existe plus — elle a peut-être été supprimée dans une autre fenêtre.",
  'st.skills.chars_count': "{count} / {max} caractères",
  'st.skills.chars_over': "Le texte au-delà de {max} caractères sera tronqué à l'enregistrement.",
  'st.skills.draft.title': "Sera enregistrée comme",
  'st.skills.draft.modes': "Modes : {modes}",
  'st.skills.draft.intents': "Intentions : {intents}",
  ...
  'st.display.cloud_bridge.desc': 'Connectez un contrôleur local à ce profil Chromium. Utilisez le port 17374 pour les clients MCP, 17375 pour le plugin LM Studio ou 17373 pour un service d’exécution cloud. Un seul pont peut être actif ; les demandes d’autorisation restent applicables.',
  ...
  'sp.attach.mime_mismatch': '{name} a été refusé : son contenu ne correspond pas au type de fichier déclaré.',
  'sp.attach.doc_legacy': '{name} est un fichier Word à l’ancien format (.doc). Enregistrez-le en .docx puis joignez-le à nouveau.',
  'sp.attach.drop_hint': 'Déposez des fichiers pour les joindre',
  'sp.attach.hint.pdf': 'PDF · {pages} pages',
  'sp.attach.hint.pdf_scan': 'PDF scanné · {pages} pages — nécessite un modèle avec vision',
  'sp.attach.hint.invalid_docx': 'Fichier .docx illisible',
  'sp.attach.outcome.sent_native': 'Envoyé au modèle',
  'sp.attach.outcome.sent_text': 'Envoyé sous forme de texte extrait',
  'sp.attach.outcome.sent_pages': 'Envoyé sous forme d’images de pages',
  'sp.attach.outcome.reference': 'Joint comme référence que l’agent peut lire à la demande',
  'sp.attach.outcome.needs_vision': 'Non envoyé — le modèle sélectionné ne peut pas voir les images',
  'sp.attach.outcome.needs_vision_scan': 'Non envoyé — ce PDF scanné nécessite un modèle avec vision',
  'sp.attach.outcome.policy': 'Non envoyé — bloqué par une règle de sécurité',
  'sp.attach.outcome.expired': 'Non envoyé — le fichier stocké a expiré ; joignez-le à nouveau',
  'sp.attach.outcome.error': 'Non envoyé — le fichier n’a pas pu être traité',
  ...
  "sp.plan.auto_approved_mode": "Plan approuvé automatiquement par le mode d’autorisation « {mode} » — en cours…",
  ...
  'st.attach.heading': 'Pièces jointes',
  'st.attach.desc': 'Les fichiers joints sont conservés sur cet appareil : les puces du composeur survivent aux rechargements et l’agent peut lire davantage d’un fichier à la demande. Leur contenu ne quitte l’appareil que lorsqu’un message est envoyé au fournisseur choisi.',
  'st.attach.retention.label': 'Conserver les fichiers joints',
  'st.attach.retention.desc': 'Durée de conservation des fichiers joints dans le stockage local après leur dernière utilisation.',
  'st.attach.retention.ttl24h': 'Jusqu’à 24 heures',
  'st.attach.retention.session': 'Session de navigateur actuelle uniquement',
  'st.attach.usage': '{count} fichiers stockés · {size}',
  'st.attach.clear.btn': 'Supprimer tous les fichiers joints',
  'st.attach.clear.done': 'Tous les fichiers joints ont été supprimés.',
  'st.attach.clear.failed': 'Impossible de supprimer les fichiers joints.',
};
